import { createDecorator } from '@sweet5/vue-facing-decorator';
import { mapActions, mapGetters, mapMutations, mapState } from 'vuex';

export type VuexDecorator = (proto: any, key: string) => void;
...
export function namespace<T extends BindingHelper>(
  ...
  function createNamespacedHelper(helper: T): T {
    ...
    function namespacedHelper(proto: any, key: string): void;
...
function createBindingHelper(
  ...
  function helper(proto: any, key: string): void;
  function helper(type: any, options?: BindingOptions): VuexDecorator;
  function helper(a: any, b?: string | BindingOptions): VuexDecorator | void {
    if (typeof b === 'string') {
      const key: string = b;
      const proto = a;
